...
#include "Friendly/RWCharacterAIFriendlyRanged.h"
...
ARWCharacterAIFriendlyRanged::ARWCharacterAIFriendlyRanged()
{
	...
	BehaviorComp->OnCompAttackFinished.BindUObject(this, &ARWCharacterAIFriendlyRanged::EndAttack);
}

void ARWCharacterAIFriendlyRanged::AttackByAI()
{
	Super::AttackByAI();
...
float ARWCharacterAIFriendlyRanged::GetAttackRange()
{
	return 1500.0f;
}

void ARWCharacterAIFriendlyRanged::CreateArrow()
{
	ArrowMeshComp->SetStaticMesh(ArrowMesh);
}

void ARWCharacterAIFriendlyRanged::ReleaseArrow()
{
...
float ARWCharacterAIFriendlyRanged::TakeDamage(float Damage, FDamageEvent const& DamageEvent, AController* EventInstigator, AActor* DamageCauser)
{
...
void ARWCharacterAIFriendlyRanged::BeginPlay()
{
	Super::BeginPlay();

}

void ARWCharacterAIFriendlyRanged::SetDead()
{
	Super::SetDead();
...
void ARWCharacterAIFriendlyRanged::BeginAttack()
{
	BehaviorComp->Attack();
}

void ARWCharacterAIFriendlyRanged::EndAttack()
{
	OnAttackFinished.ExecuteIfBound();
}

AAIControllerFriendlyRanged* ARWCharacterAIFriendlyRanged::GetMyController()
{
	return CastChecked<AAIControllerFriendlyRanged>(GetController());
}
